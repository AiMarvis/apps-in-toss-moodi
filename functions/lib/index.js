...
exports.tossUnlinkCallback = exports.loginWithToss = exports.getUserInfo = exports.createUser = exports.resetDailyCredits = exports.deleteTrack = exports.getMyTracks = exports.checkAndSaveMusic = exports.generateMusic = void 0;
...
exports.checkAndSaveMusic = functions
    ...
    try {
        // Suno API 상태 확인
        const statusResponse = await axios_1.default.get(`${SUNO_API_BASE}/api/v1/music/${taskId}`, {
            headers: {
                'Authorization': `Bearer ${SUNO_API_KEY.value()}`,
            },
            timeout: 30000,
        ...
        if (result.status === 'complete' && result.audio_url) {
            // 음악 파일 다운로드
            const audioResponse = await axios_1.default.get(result.audio_url, {
 ...
 * 매일 자정(KST)에 실행
 */
exports.resetDailyCredits = functions.pubsub
    .schedule('0 0 * * *')
    .timeZone('Asia/Seoul')
    .onRun(async () => {
    try {
