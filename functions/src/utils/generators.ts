...
const KOREAN_VOCAL_STYLES: Record<EmotionKeyword, string> = {
...
const KOREAN_LYRICAL_NARRATIVES: Record<EmotionKeyword, string> = {
...
const EMOTION_PROMPTS_ENHANCED: Record<EmotionKeyword, string> = {
...
const ALBUM_ART_MAP: Record<EmotionKeyword, string> = {
  ...
  happy: `${ALBUM_ART_BASE}/album_happy.png`,
  excited: `${ALBUM_ART_BASE}/album_excited.png`,
  grateful: `${ALBUM_ART_BASE}/album_grateful.png`,
  nostalgic: `${ALBUM_ART_BASE}/album_nostalgic.png`,
  bittersweet: `${ALBUM_ART_BASE}/album_bittersweet.png`,
  cozy: `${ALBUM_ART_BASE}/album_cozy.png`,
  hopeful: `${ALBUM_ART_BASE}/album_hopeful.png`,
  empty: `${ALBUM_ART_BASE}/album_empty.png`,
  lonely: `${ALBUM_ART_BASE}/album_lonely.png`,
  stressed: `${ALBUM_ART_BASE}/album_stressed.png`,
  frustrated: `${ALBUM_ART_BASE}/album_frustrated.png`,
  disappointed: `${ALBUM_ART_BASE}/album_disappointed.png`,
};
